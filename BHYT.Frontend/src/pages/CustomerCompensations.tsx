...
import * as compensatioServices from "../services/compensationServices";
import { useStore } from "../app/store";
import HourglassTopIcon from "@mui/icons-material/HourglassTop";
import { CheckCircle } from "@mui/icons-material";
import CloseIcon from "@mui/icons-material/Close";

interface ICustomerCompensation {
  id: number;
  guid: string;
  policyId: number;
...
function CustomerCompensations(): JSX.Element {
  ...
  const columns: GridColDef[] = [
    { field: "policyId", headerName: "Mã chính sách", flex: 0.5, align: "center" },
    {
      field: "dateRequest",
    ...
    },
    {
      ...
      headerName: "Số tiền",
      flex: 0.5,
      valueFormatter: (params) => params.value.toLocaleString("it-IT", { style: "currency", currency: "VND" }),
    },
    {
      field: "getOption",
...
export default CustomerCompensations;
